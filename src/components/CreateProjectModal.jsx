...
export const CreateProjectModal = ({ isOpen, onClose, onProjectCreated }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!title.trim() || !description.trim() || !liveLink.trim() || !imageFile) {
  ...
  return (
    <ProjectModal isOpen={isOpen} onClose={handleClose} title="Add New Project">
      <form onSubmit={handleSubmit} className="space-y-4 text-left">
        ...
        <div className="space-y-1">
          ...
          <textarea
            required
            placeholder="Describe the project objective, features and system design..."
            value={description}
          ...
          {imagePreview ? (
            ...
            >
              ...
              <div className="text-center">
                <p className="text-xs font-medium text-zinc-300">Click to upload image</p>
